            ...
            <div class="p-4 flex flex-wrap items-center justify-between gap-3" style="border-bottom: 1px solid #C8BFBF;">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition
                            class="absolute top-full right-0 mt-1 bg-white rounded-lg shadow-xl z-50 w-56 py-1"
                            style="border: 1px solid #C8BFBF;">
                            <div class="px-3 py-1 text-xs text-gray-400 font-medium">Current View (max 5000)</div>
                            ...
                            <div class="border-t my-1" style="border-color: #C8BFBF;"></div>
                            <div class="px-3 py-1 text-xs text-gray-400 font-medium">All Data (no limit)</div>
                            <button @click="exportData('csv', 'all'); open = false"
                                class="w-full px-4 py-2 text-left text-sm hover:bg-gray-50 flex items-center gap-2">
