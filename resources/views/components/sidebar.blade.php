...
<aside
    ...
    <nav class="flex-1 py-4 px-2 space-y-1 overflow-y-auto">
        ...
        <a href="{{ route('photo-upload') }}"
            class="flex items-center gap-3 px-3 py-2.5 text-white rounded-lg transition-all duration-200 hover:bg-white/15 {{ request()->routeIs('photo-upload') ? 'bg-white/20' : '' }}"
            :class="!sidebarOpen && 'justify-center'">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
            <span x-show="sidebarOpen" class="whitespace-nowrap text-sm">Photo Upload</span>
        </a>
