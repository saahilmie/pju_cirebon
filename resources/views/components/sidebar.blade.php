...
<aside class="sidebar fixed left-0 top-0 h-full bg-gradient-to-b from-[#29AAE1] to-[#1E8CC0] z-50 shadow-xl transition-all duration-300 flex flex-col"
