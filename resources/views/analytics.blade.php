            ...
            <div class="flex flex-wrap items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-2">
                    <button @click="exportPDF()"
                        class="flex items-center gap-2 px-4 py-2 bg-white border-2 border-[#29AAE1] text-[#29AAE1] rounded-lg hover:bg-blue-50 text-sm font-medium">
                    ...
                    <button @click="exportExcel()"
                        class="flex items-center gap-2 px-4 py-2 bg-[#29AAE1] text-white rounded-lg hover:bg-[#1E8CC0] text-sm font-medium">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
            ...
            function analyticsPage() {
                return {
                    ...
                    exportExcel() {
                        ...
                        // IDPEL Anomaly sheet
                        if (this.idpelData.data && this.idpelData.data.length) {
